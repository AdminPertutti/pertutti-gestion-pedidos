...
$(document).ready(function() {
  ...
  function incrementara(a) {
      ...
      let valoract = parseInt(cantidad.value, 10);
      if (cantidad.value < 9) valor = valoract + 1;
      else valor = 0;
  ...
  function incrementar() {
      ...
      if (valor.value < 9) valor.value++;
      if (ad1.value < 9) ad1.value++;
      boton = document.getElementById("enviar");
      if (ad1.value == 0 && ad2.value == 0)boton.disabled = true;
      else boton.disabled = false;
  }
  function incrementar2() {
      var valor = document.getElementById("item2"),ad2 = document.getElementById("ad2");
      if (valor.value < 9) valor.value++;
      if (ad2.value < 9) ad2.value++;
      boton = document.getElementById("enviar");
      if (ad2.value == 0 && ad1.value == 0)boton.disabled = true;
      else boton.disabled = false;
  }
  function decrementar() {
      var valor = document.getElementById("item1"), ad1 = document.getElementById("ad1");
      if (valor.value > 0) valor.value--;
      if (ad1.value > 0){ ad1.value--;
      boton = document.getElementById("enviar");
      if (ad1.value == 0 && ad2.value == 0)boton.disabled = true;
      }
      else boton.disabled = false;
  ...
  function confirma() {
    event.preventDefault();
      ...
      function confirmarepo() {   //inicio de  CONFIRMAREPO
        event.preventDefault();
            var sesion = 0;
